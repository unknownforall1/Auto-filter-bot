...
from info import ADMINS, AUTH_CHANNEL, AUTH_USERS, SUPPORT_CHAT_ID, CUSTOM_FILE_CAPTION, MSG_ALRT, PICS, AUTH_GROUPS, P_TTI_SHOW_OFF, GRP_LNK, CHNL_LNK, NOR_IMG, LOG_CHANNEL, SPELL_IMG, MAX_B_TN, IMDB, \
    SINGLE_BUTTON, SPELL_CHECK_REPLY, IMDB_TEMPLATE, NO_RESULTS_MSG, TUTORIAL, REQST_CHANNEL, IS_TUTORIAL, LANGUAGES, SEASONS, SUPPORT_CHAT, PREMIUM_USER, GET_QUERY_CHANNEL, NO_RESULTS_MSG_CHNL
        ...
        if manual == False:
            ...
            try:
                if settings['auto_ffilter']:
                    ...
                    await client.send_message(chat_id=GET_QUERY_CHANNEL,text=f"<b>#QUERY_MSG\n\n by {message.from_user.mention} \n\nMessage : {message.text}</b>")
            except KeyError:
